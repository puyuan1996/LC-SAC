...
from spinup.algos.pytorch.sac.sac_q_pi_v2 import SAC
...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', type=str,
                        default='Striker-v2')  # BipedalWalker-v3' MountainCarContinuous-v0' HalfCheetah-v2'
    ...
    parser.add_argument('-latent_uf', '--latent_encoder_update_frequency', type=int, default=1000)
