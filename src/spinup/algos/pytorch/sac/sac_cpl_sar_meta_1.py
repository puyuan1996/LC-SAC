...
class SAC(object):
    def __init__(self, env, env_name, agent, q1_net, q2_net, seed=0,
        ...
        prefix = './result_cplsar_noQLoss_meta_ml1_train1_test1_train_z_det' if self.z_deterministic else './result_cplsar_noQLoss_meta_ml1_train1_test1_train_z_prob'  # TODO
