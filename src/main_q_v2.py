...
from spinup.algos.pytorch.sac.sac_q_v2 import SAC
...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', type=str,
                        default='Ant-v2')  # Striker-v2')  # BipedalWalker-v3' MountainCarContinuous-v0' HalfCheetah-v2'
    ...
    parser.add_argument('-latent_bs','--latent_buffer_size', type=int, default=1000000)  # 5000
