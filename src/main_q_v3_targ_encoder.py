...
from spinup.algos.pytorch.sac.sac_v3_targ_encoder import SAC
...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', type=str,
                        default='Striker-v2')  # Hopper-v2')Striker-v2')  # BipedalWalker-v3' MountainCarContinuous-v0' HalfCheetah-v2'
    ...
    parser.add_argument('--seq_len', type=int, default=80)  # 20)
