...
from spinup.algos.pytorch.sac.sac_tcl_det_v2 import SAC
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='./model_tcl_det/')
    ...
    parser.add_argument('-latent_uf', '--latent_encoder_update_frequency', type=int, default=10000)  # 5000 TODO
    ...
    parser.add_argument('--rl_buffer_size', type=int, default=10000) # 5000 TODO
    # 100 1e-3
    # 1 1e-6
