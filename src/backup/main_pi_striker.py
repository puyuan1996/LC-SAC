...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', type=str, default='Striker-v2')  # BipedalWalker-v3' MountainCarContinuous-v0' HalfCheetah-v2'
    ...
    parser.add_argument('-latent_hd','--latent_encoder_hidden_dim', type=int, default=64)
    ...
    parser.add_argument('-latent_uf','--latent_encoder_update_frequency', type=int, default=1)
    parser.add_argument('--latent_lr', type=float, default=1e-6)
    parser.add_argument('--sac_lr', type=float, default=1e-3)#1e-3)
    # parser.add_argument('--latent_buffer_size', type=int, default=10000) # 1000
    # 100 1e-3
    # 1 1e-6
